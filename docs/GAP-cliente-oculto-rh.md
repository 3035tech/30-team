...
| 3 | Assessment comportamental + metodologia + entrega | **tem** | Eneagrama T1–T9 (`/t` `/v`); hedging |
...
- Segundo instrumento tipo DISC  
- Conta de candidato / portal colaborador full  
- ATS genérico (CV parsing, calendário, oferta enterprise)  
- LMS / folha / DP / ponto  

## Concorrentes citados na planilha (só referência)

Alina, TeamCulture, Qulture.Rocks, Feedz, WURK, Sólides, Gupy, InCicle, Pulsefy, TagguiRH, impulseup, beewell, mindsight.
