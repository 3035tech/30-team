...
export function buildOpenAiMockCompletion({ messages } = {}) {
  ...
  const isEn = /\byou are the 30team product help\b/.test(lower) || /\bquestion:\b/.test(lower);
  ...
  if (
    lower.includes('30team product help') ||
    lower.includes('assistente de ajuda do 30team') ||
