 ...
 * Display uses the selected BCP 47 locale through Intl (for example,
 * pt-BR/pt-PT → day-first and en-US → month-first).
 */
...
export function formatDisplayDate(value, locale = 'pt-BR', opts = {}) {
  ...
  const lang = localeNumberLocale(normalizeLocale(locale));
