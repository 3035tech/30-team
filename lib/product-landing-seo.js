...
const COPY = {
  'pt-BR': {
    ...
    metaDescription:
      'Software houses e agências de produto: pare de decidir no feeling e de perder a pessoa depois do hire. 30Team une funil, Eneagrama no trabalho, Motivadores, briefing, 1:1 e pós-contratação. Early access sem custo. 3035Tech.',
    metaKeywords: [
      'software RH',
    ...
    heroBody:
      'Pare de perder a pessoa na segunda semana. Ranking, 1:1, chegada e clima no mesmo lugar. Sem laudo. Sem PDF que some.',
  ...
  en: {
    ...
    metaDescription:
      'Software houses and product agencies: stop hiring on gut feel and losing people after day one. 30Team connects funnel, Enneagram-at-work, Motivators, briefs, 1:1s, and post-hire. Free early access. 3035Tech.',
    metaKeywords: [
      'HR software',
    ...
    heroBody:
      'Stop losing the person in week two. Ranking, 1:1s, arrival, and climate in one place. No clinical label. No PDF that vanishes.',
