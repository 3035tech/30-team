...
const COPY = {
  'pt-BR': {
    ...
    metaDescription:
      'Plataforma de RH para recrutar, compreender estilos de trabalho e acompanhar pessoas. Vagas, T1–T9, Motivadores, 1:1, PDI, clima, LMS e DP leve.',
    metaKeywords: [
      'software RH',
  ...
  en: {
    ...
    metaDescription:
      'HR platform to recruit, understand work styles, and support people. Jobs, T1–T9, Motivators, 1:1s, development plans, climate, LMS, and light HR ops.',
    metaKeywords: [
      'HR software',
