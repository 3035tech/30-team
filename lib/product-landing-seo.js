...
const TECHNICAL_FOR_LLMS = {
  ...
  urls: [
    ...
    { path: '/j', use: 'Public SEO job postings' },
...
const COPY = {
  'pt-BR': {
    ...
    metaDescription:
      'Pare de escolher entre ATS sem conversa e teste de personalidade que vira PDF. 30Team une funil de vagas, Eneagrama aplicado ao trabalho, Motivadores, briefing, 1:1, clima e jornada pós-contratação. Early access sem custo para primeiros parceiros. 3035Tech.',
    metaKeywords: [
      'software RH',
    ...
    heroFoot: 'Já é cliente? Entre no painel. Ainda não? Garanta o early access gratuito.',
  ...
  en: {
    ...
    metaDescription:
      'Stop choosing between an ATS with no conversation and a personality test that becomes a PDF. 30Team connects vacancy funnel, Enneagram-at-work profile, Motivators, interview brief, 1:1s, climate, and light post-hire. Free early access for first partners. 3035Tech.',
    metaKeywords: [
      'HR software',
    ...
    heroFoot: 'Already a customer? Sign in. Not yet? Claim free early access.',
    ...
    pillars: [
      ...
      },
      {
        ...
        items: [
          ...
          'Development plans with progress, cycle, owner',
