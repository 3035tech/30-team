...
const COPY = {
  'pt-BR': {
    ...
    metaDescription:
      'Plataforma de RH para recrutar, compreender estilos de trabalho e acompanhar pessoas. Vagas, T1–T9, PDI, clima, LMS e app do colaborador.',
    metaKeywords: [
      'software RH',
    ...
    earlyBadge: 'Do recrutamento ao desenvolvimento',
    ui: {
      ...
      heroProof: ['Piloto gratuito', 'Sem cartão', 'Português e inglês'],
  ...
  en: {
    ...
    metaDescription:
      'HR platform to recruit, understand work styles, and support people. Jobs, T1–T9, development plans, climate, LMS, and a collaborator app.',
    metaKeywords: [
      'HR software',
    ...
    earlyBadge: 'From recruiting to development',
    ui: {
      ...
      heroProof: ['Free pilot', 'No credit card', 'Portuguese and English'],
...
export function buildProductLandingJsonLd(locale = 'pt-BR') {
  ...
  const software = {
    ...
    featureList: [...copy.pillars.flatMap((p) => p.items), ...copy.employeeApp.features],
    audience: {
      '@type': 'Audience',
