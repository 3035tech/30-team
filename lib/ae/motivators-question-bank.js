/**
 * Banco de Motivadores v4 — situações de trabalho em linguagem clara.
 * Dimensões ficam só nos pesos (servidor). O respondente não vê nomes de motivadores.
 *
 * Regras de copy: 1 ideia por frase; vocabulário de trabalho (salário, horário, meta, método);
 * sem metáfora obscura (recorte, itinerário, degrau, “gosto”, etc.).
 *
 *  - forced_choice: 1 entre 4 opções
 *  - ranking: mais → menos
...
const FORCED_TEMPLATES = [
  {
    stem: 'Ao terminar um projeto que deu certo, o que mais faria a experiência valer a pena para você?',
    category: 'fechamento',
    options: [
      { text: 'Receber um valor extra ligado a esse resultado.', weights: { financeiro: 4, reconhecimento: 1 } },
      { text: 'Assumir em seguida algo com mais responsabilidade.', weights: { crescimento: 4, lideranca: 2 } },
      { text: 'Alguém da gestão ou do time reconhecer com clareza o que você entregou.', weights: { reconhecimento: 4, relacionamentos: 1 } },
      { text: 'Já ter na mesa um problema novo, mais difícil que o anterior.', weights: { desafio: 4, autonomia: 1 } },
    ],
  },
  {
    stem: 'Duas rotinas possíveis no mesmo cargo. Qual tende a funcionar melhor para você no dia a dia?',
    category: 'rotina',
    options: [
      { text: 'Saber com antecedência o que vem pela frente e ter poucas mudanças de última hora.', weights: { seguranca: 4, equilibrio: 1 } },
      { text: 'Conseguir equilibrar o trabalho com a vida pessoal, sem precisar estar sempre disponível.', weights: { equilibrio: 4, flexibilidade: 2 } },
      { text: 'Poder ajustar horário e local conforme a semana, desde que a entrega saia.', weights: { flexibilidade: 4, autonomia: 2 } },
      { text: 'Ter liberdade para decidir como fazer o trabalho, desde que o resultado combinado aconteça.', weights: { autonomia: 4, flexibilidade: 1 } },
    ],
  },
  {
    stem: 'Você recebeu uma atividade nova. O que mais ajuda a começar com disposição?',
    category: 'inicio',
    options: [
      { text: 'Entender o resultado esperado e escolher como chegar lá.', weights: { autonomia: 4, desafio: 1 } },
      { text: 'Ter alguém do time para alinhar no começo e não ficar sozinho.', weights: { relacionamentos: 4, seguranca: 1 } },
      { text: 'Ver que a atividade serve para alguém de verdade, não só para um relatório.', weights: { proposito: 4, relacionamentos: 1 } },
      { text: 'Haver espaço para testar um jeito de trabalhar que ainda não foi usado aqui.', weights: { criatividade: 4, autonomia: 2 } },
    ],
  },
  {
    ...
    category: 'frustracao',
    options: [
      { text: 'Cada passo já vem prescrito, com pouco espaço para decidir o método.', weights: { autonomia: 4, flexibilidade: 1 } },
      { text: 'Entregar bem e ninguém registrar que aquilo fez diferença.', weights: { reconhecimento: 4, proposito: 1 } },
      { text: 'A remuneração ficar claramente abaixo do mercado para o mesmo esforço.', weights: { financeiro: 4, seguranca: 2 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Uma permite montar a semana com mais equilíbrio entre trabalho e vida pessoal.', weights: { equilibrio: 4, flexibilidade: 2 } },
    ],
  },
  {
    stem: 'Num dia em que tudo deu errado, o que mais ajudaria a retomar o ritmo?',
    ...
    options: [
      ...
      { text: 'Conversar com colegas de confiança e resolver junto.', weights: { relacionamentos: 4, seguranca: 1 } },
      { text: 'Lembrar para quem ou para que aquela entrega existe.', weights: { proposito: 4, relacionamentos: 1 } },
      { text: 'Pegar um pedaço difícil e resolver, mesmo que seja pequeno.', weights: { desafio: 4, desenvolvimento: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Um acordo claro de salário e benefícios.', weights: { financeiro: 4, seguranca: 2 } },
      { text: 'Combinar local e horário de um jeito que a semana feche melhor.', weights: { flexibilidade: 4, equilibrio: 2 } },
      { text: 'Um caminho visível para assumir mais responsabilidade no que já faz.', weights: { crescimento: 4, lideranca: 1 } },
    ],
  },
  {
    ...
    category: 'oferta',
    options: [
      { text: 'O conjunto do que você recebe por mês e o que cobre imprevistos.', weights: { financeiro: 4, seguranca: 1 } },
      { text: 'Dá para ver, no dia a dia, para que o trabalho serve.', weights: { proposito: 4, relacionamentos: 1 } },
      { text: 'Há problemas difíceis, não só repetição do que você já sabe fazer.', weights: { desafio: 4, desenvolvimento: 2 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Ficar com o problema técnico ou de processo que ninguém quer.', weights: { desafio: 4, desenvolvimento: 2 } },
      { text: 'Manter o alinhamento entre as pessoas para o trabalho não travar.', weights: { relacionamentos: 4, proposito: 1 } },
      { text: 'Sugerir uma abordagem diferente da que já estava no plano.', weights: { criatividade: 4, autonomia: 2 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Combinar o resultado e deixar o método com você.', weights: { autonomia: 4, desenvolvimento: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Passar a ter menos liberdade para decidir o próprio trabalho.', weights: { autonomia: 4, flexibilidade: 1 } },
  ...
  {
    stem: 'Qual dessas situações descreve melhor um ambiente em que você rende?',
    category: 'ambiente',
    options: [
      { text: 'Combinados claros e poucas surpresas de processo.', weights: { seguranca: 4, flexibilidade: 1 } },
      { text: 'Pessoas acessíveis: fácil pedir e oferecer ajuda.', weights: { relacionamentos: 4, proposito: 1 } },
      { text: 'Metas desafiadoras, com pressão que ainda dá para respirar.', weights: { desafio: 4, crescimento: 2 } },
      { text: 'Dá para testar ideias sem pedir autorização a cada detalhe.', weights: { criatividade: 4, autonomia: 2 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Pegar um pedaço real do trabalho que você ainda não fez.', weights: { desafio: 3, desenvolvimento: 4 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Ter liderado uma frente que outras pessoas passaram a seguir.', weights: { lideranca: 4, reconhecimento: 2 } },
      { text: 'Alguém de fora do time ter notado o efeito do que você fez.', weights: { proposito: 4, reconhecimento: 2 } },
      { text: 'Sair sabendo fazer algo que no início do trimestre você não sabia.', weights: { desenvolvimento: 4, crescimento: 3 } },
    ],
  },
  {
    ...
    category: 'gesto',
    options: [
      { text: 'Um extra em dinheiro ligado àquele resultado.', weights: { financeiro: 4, reconhecimento: 2 } },
      { text: 'Entrar num tema que o time ainda não resolveu.', weights: { desafio: 3, crescimento: 4 } },
      { text: 'Tempo com alguém sênior para alinhar o que vem depois.', weights: { desenvolvimento: 4, lideranca: 2 } },
      { text: 'Alguém reconhecer a entrega na frente de quem importa para o trabalho.', weights: { reconhecimento: 4, relacionamentos: 1 } },
    ],
  },
  {
  ...
  {
    stem: 'Na hora de ficar ou sair, o que costuma pesar mais na sua decisão?',
    ...
    options: [
      ...
      { text: 'Ainda há espaço para crescer no que você já construiu.', weights: { crescimento: 4, desenvolvimento: 2 } },
      { text: 'Você organiza o próprio trabalho sem ser vigiado a cada passo.', weights: { autonomia: 4, flexibilidade: 3 } },
    ],
  },
  {
    stem: 'Qual combinação de semana tende a te deixar melhor na sexta-feira?',
    category: 'semana',
    options: [
      { text: 'Horários estáveis e dá para marcar o resto da vida em volta.', weights: { equilibrio: 4, seguranca: 2 } },
  ...
  },
  {
    ...
    category: 'meta',
    options: [
      { text: 'Número claro ligado a resultado que pode virar remuneração variável.', weights: { financeiro: 3, desafio: 4 } },
      { text: 'Construir relação estável com quem usa o que você entrega.', weights: { relacionamentos: 4, proposito: 1 } },
      { text: 'Dominar um campo que ainda falta no seu repertório.', weights: { desenvolvimento: 4, crescimento: 2 } },
      { text: 'Criar uma solução que ainda não está no manual.', weights: { criatividade: 4, desafio: 1 } },
    ],
  },
  {
    ...
    category: 'mobilidade',
    options: [
      { text: 'Vai exigir habilidades que você ainda está formando.', weights: { desenvolvimento: 4, desafio: 2 } },
      ...
      { text: 'Há espaço para propor o formato do trabalho, não só herdar o anterior.', weights: { criatividade: 4, autonomia: 2 } },
    ],
  },
  {
    ...
    category: 'sucesso',
    options: [
      { text: 'A vida material ficou mais estável do que no período anterior.', weights: { financeiro: 4, seguranca: 2 } },
      ...
      { text: 'O que você sabe fazer hoje não existia no início.', weights: { desenvolvimento: 4, crescimento: 3 } },
    ],
  },
  {
    ...
    category: 'gestao',
    options: [
      { text: 'Reconhecer entregas boas no momento em que acontecem, não só no fim do ano.', weights: { reconhecimento: 4, relacionamentos: 1 } },
      ...
      { text: 'Respeitar o fim do expediente quando a urgência não é real.', weights: { equilibrio: 4, relacionamentos: 1 } },
    ],
  },
  {
    ...
    category: 'restricao',
    options: [
      { text: 'Tudo precisa de aprovação antes de qualquer ajuste de método.', weights: { autonomia: 4, criatividade: 1 } },
      { text: 'Ninguém comenta o que funcionou: só o que faltou.', weights: { reconhecimento: 4, relacionamentos: 1 } },
      { text: 'A mesma tarefa, do mesmo jeito, mês após mês.', weights: { desafio: 4, criatividade: 2 } },
      { text: 'Reunião e mensagem fora do combinado, como se fosse normal.', weights: { equilibrio: 4, flexibilidade: 1 } },
    ],
  },
  {
    stem: 'Você vai liderar uma frente de três meses. O que mais te faria dizer sim com vontade?',
    category: 'frente',
    options: [
      ...
      { text: 'Há um problema que o time ainda não resolveu.', weights: { desafio: 4, desenvolvimento: 1 } },
  ...
  },
  {
    ...
    category: 'disposicao',
    options: [
      { text: 'Saber que o combinado de horário e local aguenta um imprevisto pequeno.', weights: { flexibilidade: 4, equilibrio: 2 } },
      ...
      { text: 'Sentir que a semana trouxe aprendizado novo, não só mais volume.', weights: { desenvolvimento: 4, desafio: 1 } },
    ],
  },
  {
    stem: 'Qual destas situações descreve melhor o tipo de confiança que te faz render?',
    category: 'confianca',
    options: [
      { text: 'Combinaram o resultado; o método fica com você.', weights: { autonomia: 4, desafio: 1 } },
      { text: 'Dá para prever o mês com pouca mudança brusca de prioridade.', weights: { seguranca: 4, equilibrio: 1 } },
      { text: 'Tem gente ao lado quando a pauta aperta.', weights: { relacionamentos: 4, seguranca: 1 } },
      { text: 'Erro pontual ao testar algo novo não vira cobrança exagerada.', weights: { criatividade: 4, autonomia: 2 } },
    ],
  },
];
...
const RANKING_QUESTIONS = [
  {
    stem: 'Qual dessas situações mais influencia sua satisfação no trabalho? Ordene da que mais pesa para a que menos pesa.',
    category: 'satisfacao',
    options: [
      { text: 'O salário e os benefícios cobrem o mês com folga, sem aperto constante.', weights: { financeiro: 2 } },
      { text: 'Alguém que importa para o trabalho reconhece com precisão o que você fez.', weights: { reconhecimento: 2 } },
      { text: 'Dá para ver o próximo passo de cargo, não só mais do mesmo.', weights: { crescimento: 2 } },
      { text: 'Com o resultado combinado, você escolhe como chegar lá.', weights: { autonomia: 2 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: 'Poder mudar horário ou local quando a semana pede.', weights: { flexibilidade: 2 } },
  ...
  {
    stem: 'O que mais faria você continuar neste time daqui a um ano? Ordene da influência maior para a menor.',
    category: 'permanecer',
    options: [
      { text: 'O trabalho ainda faz sentido para alguém além da planilha.', weights: { proposito: 2 } },
      { text: 'As relações do dia a dia aguentam pressão sem virar conflito permanente.', weights: { relacionamentos: 2 } },
      { text: 'Ainda aparecem problemas que exigem mais do que o automático.', weights: { desafio: 2 } },
      { text: 'Há espaço para liderar rumo, não só executar lista.', weights: { lideranca: 2 } },
    ],
  },
  {
    stem: 'No dia a dia, o que mais pesa para a semana fechar bem? Ordene do mais ao menos relevante.',
    category: 'semana',
    options: [
      { text: 'Sobrou energia para o que não é trabalho.', weights: { equilibrio: 2 } },
      { text: 'Deu para testar um jeito de trabalhar que ainda não estava no processo.', weights: { criatividade: 2 } },
      { text: 'Ficou visível que a sua parte moveu o resultado.', weights: { reconhecimento: 2 } },
      { text: 'A semana deixou um passo a mais na carreira, não só volume.', weights: { crescimento: 2 } },
    ],
  },
  {
    ...
    category: 'projeto',
    options: [
      { text: 'Dá para criar a abordagem, não só copiar o último projeto.', weights: { criatividade: 2 } },
  ...
  {
    stem: 'Qual dessas condições mais protege seu engajamento numa fase puxada? Ordene da mais à menos importante.',
    ...
    options: [
      ...
      { text: 'Alguém reconhecer o esforço enquanto ele acontece.', weights: { reconhecimento: 2 } },
...
const LIKERT_STATEMENTS = [
  ...
  { text: 'Quando o salário não acompanha o esforço, a semana inteira fica mais pesada. Mesmo com o resto em ordem.', category: 'conta_do_mes', weights: { financeiro: 4, seguranca: 1 } },
  { text: 'De tempos em tempos, comparo o que recebo com o que gente na mesma função recebe fora daqui.', category: 'conta_do_mes', weights: { financeiro: 4 } },
  { text: 'Um extra ligado a resultado concreto me motiva mais do que um elogio solto, sem consequência prática.', category: 'conta_do_mes', weights: { financeiro: 4, reconhecimento: 1 } },
  ...
  { text: 'Uma semana mais cheia ainda vale a pena se, no fim, eu saio com uma responsabilidade que ainda não tinha.', category: 'trajeto', weights: { crescimento: 4, desafio: 1 } },
  ...
  { text: 'Semanas em que só repito o que já sei fazer me desmotivam mais do que semanas puxadas com aprendizado.', category: 'aprender', weights: { desenvolvimento: 4, desafio: 1 } },
  ...
  { text: 'Rendo mais quando combinamos o resultado e o método fica comigo.', category: 'caminho', weights: { autonomia: 4 } },
  { text: 'Ter cada passo já desenhado por outra pessoa tira a motivação da tarefa, mesmo quando o tema é interessante.', category: 'caminho', weights: { autonomia: 4, flexibilidade: 1 } },
  { text: 'Cobrança de método a cada hora reduz minha disposição mais do que uma meta apertada com liberdade de execução.', category: 'caminho', weights: { autonomia: 4 } },

  { text: 'Poder ajustar um bloco da agenda (horário ou local) quando a vida pede tende a me deixar mais inteiro no trabalho.', category: 'encaixe', weights: { flexibilidade: 4, equilibrio: 1 } },
  ...
  { text: 'Ver o efeito do trabalho em alguém concreto me motiva mais do que um indicador interno sem rosto.', category: 'para_quem', weights: { proposito: 4 } },
  ...
  { text: 'Ter com quem conversar quando o trabalho emperra pesa tanto quanto a própria dificuldade técnica.', category: 'gente', weights: { relacionamentos: 4, seguranca: 1 } },
  ...
  { text: 'Rendo melhor quando o time conversa de verdade, não só troca tarefa no chat.', category: 'gente', weights: { relacionamentos: 4, proposito: 1 } },
  ...
  { text: 'Prefiro um mês previsível a um mês “brilhante” se o brilho vier com mudança constante de prioridade.', category: 'previsao', weights: { seguranca: 4 } },
  ...
  { text: 'Um problema que ainda não tem solução pronta me tira do automático. E isso costuma valer o esforço extra.', category: 'no_dificil', weights: { desafio: 4, crescimento: 1 } },
  { text: 'Meta apertada com chance real de não bater me motiva mais do que meta folgada que sempre se cumpre.', category: 'no_dificil', weights: { desafio: 4, reconhecimento: 1 } },
  { text: 'Semanas só de repetição conhecida me esvaziam mais do que semanas densas com problema novo.', category: 'no_dificil', weights: { desafio: 4, criatividade: 1 } },

  { text: 'Quando dá para testar uma abordagem nova que ainda não está no processo, a tarefa tende a engajar mais.', category: 'jeito_novo', weights: { criatividade: 4, autonomia: 1 } },
...
/** Prefixo estável desta geração — não colide com v2/v3 (fc_01 / v3_*). */
export const MOTIVATORS_QUESTION_BANK_GENERATION = 'v4';
...
/** Dimension keys must never appear as jargon in respondent-facing stems/options. */
const DIMENSION_KEY_LEAK = new RegExp(
  `\\b(${[
    'reconhecimento',
    'financeiro',
    'crescimento',
...
const INSTRUMENT_JARGON = /\b(dimens[aã]o|instrumento|motivadores?\s+profissionais|eneagrama)\b/i;

/**
 * B-RH2-20: respondent copy must stay situational workplace language.
 * @returns {{ ok: true } | { ok: false, issues: Array<{ key: string, reason: string }> }}
 */
export function validateMotivatorsRespondentCopy(bank = generateMotivatorsQuestionBank()) {
  const issues = [];
  for (const q of bank || []) {
    const parts = [q.text, ...(q.options || []).map((o) => o.text)];
    for (const part of parts) {
      const text = String(part || '');
      if (DIMENSION_KEY_LEAK.test(text)) {
        issues.push({ key: q.key, reason: `dimension key leak: ${text.slice(0, 80)}` });
      }
      if (INSTRUMENT_JARGON.test(text)) {
        issues.push({ key: q.key, reason: `instrument jargon: ${text.slice(0, 80)}` });
      }
      if (/\s—\s/.test(text)) {
        issues.push({ key: q.key, reason: 'em dash with spaces in respondent copy' });
      }
    }
  }
