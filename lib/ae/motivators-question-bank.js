...
const LIKERT_STATEMENTS = [
  ...
  { text: 'Poder mudar um bloco da agenda — horário ou local — quando a vida pede me deixa mais inteiro no trabalho.', category: 'encaixe', weights: { flexibilidade: 4, equilibrio: 1 } },
  ...
  { text: 'Quando dá para testar uma abordagem nova que ainda não está no processo, a tarefa fica mais motivadora.', category: 'jeito_novo', weights: { criatividade: 4, autonomia: 1 } },
