 ...
 * @param {{ query: Function }} db — pool client com .query()
 */
export async function bootstrapMotivators(db, { forceQuestions = false } = {}) {
...
export async function getMotivatorsStatus(db) {
  try {
