 ...
 * Colors avoid brand purple (#7C3AED) and status danger (#dc2626) to reduce collisions.
 */
export const MOTIVATORS_DIMENSIONS = [
  { key: 'reconhecimento', label: 'Reconhecimento', color: '#c026d3', sortOrder: 1 },
  ...
  { key: 'desafio', label: 'Desafio', color: '#ea580c', sortOrder: 11 },
  { key: 'criatividade', label: 'Criatividade', color: '#7e22ce', sortOrder: 12 },
