...
export const MOTIVATORS_DIMENSIONS = [
  { key: 'reconhecimento', label: 'Reconhecimento', labelEn: 'Recognition', color: '#c026d3', sortOrder: 1 },
  ...
  { key: 'criatividade', label: 'Criatividade', labelEn: 'Creativity', color: '#7e22ce', sortOrder: 12 },
