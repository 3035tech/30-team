...
function systemPrompt(locale) {
  ...
  return en
    ? [
        'You are a 30Grow people-ops assistant. Interpret ONLY the JSON signals provided.',
    ...
    : [
        'Você é assistente de people-ops do 30Grow. Interprete SOMENTE os sinais JSON fornecidos.',
