...
export async function updateCandidateOffer(dbOrQuery, {
  ...
  if (vc.rowCount === 0) {
    ...
    if (ass.rowCount === 0 && !assessmentId) return { ok: false, errorCode: 'NOT_FOUND' };
