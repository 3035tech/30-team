...
import { PERFORMANCE_GOAL_OUTCOME, PERFORMANCE_REVIEW_STATUS } from '../domain-status.js';

export const CALIBRATION_LIST_CAP = 80;

const OUTCOME_SCORE = Object.freeze({
  [PERFORMANCE_GOAL_OUTCOME.EXCEEDED]: 100,
  [PERFORMANCE_GOAL_OUTCOME.MET]: 75,
  [PERFORMANCE_GOAL_OUTCOME.DEVELOP]: 50,
  [PERFORMANCE_GOAL_OUTCOME.NOT_MET]: 25,
});
