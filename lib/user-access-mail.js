/**
 * E-mail de acesso ao painel — convite para definir senha (link com token).
 */
...
/**
 * @param {{ email: string, setupUrl: string, locale?: string, displayName?: string|null }} opts
 */
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" style="max-width:560px;background:#fff;border-radius:16px;border:1px solid rgba(26,22,37,0.08);">
        <tr><td style="padding:28px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;">
          ...
          <p style="margin:0 0 20px;font-size:14px;color:${TEXT};"><strong>${t(loc, 'mail.userAccess.textEmail')}:</strong> ${escapeHtml(email)}</p>
