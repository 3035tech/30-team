 ...
 * @param {{ selectedArea: string, areaStats: object|null, areaRubric: object|null, rubricByAreaKey: Record<string, object> }} ctx
 */
export function enrichAssessmentDashboardRow(r, ctx) {
  const { selectedArea, areaStats, areaRubric, rubricByAreaKey } = ctx;
