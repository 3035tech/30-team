...
/** Agregador SEO: vagas remotas (`workplace_modality = remote`). */
export const PUBLIC_REMOTE_AGGREGATOR_PATH = `${PUBLIC_JOB_PATH_PREFIX}/remoto`;

/** Prefixo de agregadores por cidade: `/j/cidade/{slug}`. */
export const PUBLIC_CITY_AGGREGATOR_PREFIX = `${PUBLIC_JOB_PATH_PREFIX}/cidade`;
