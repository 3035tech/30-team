...
import { localeHtmlLang, t, normalizeLocale } from './i18n.js';
import { publicPricingCurrency } from './pricing-currency.js';
export { EARLY_ADOPTER_MONTHLY_RATE, EARLY_ADOPTER_ANNUAL_DISCOUNT } from './pricing-currency.js';
import {
...
export const EARLY_ADOPTER_MIN_EMPLOYEES = 5;
export const EARLY_ADOPTER_MAX_EMPLOYEES = 500;
export const PUBLIC_TRIAL_DAYS = 30;
export const EARLY_ADOPTER_FREE_DAYS = 90;
export const EARLY_ADOPTER_COHORT_LIMIT = 20;
export const DESIGN_PARTNER_FREE_MONTHS = 6;
...
export function buildPricingMetadata(locale = 'pt-BR') {
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      siteName: '30Grow',
      locale: loc === 'en' ? 'en_US' : loc === 'es-419' ? 'es_419' : 'pt_BR',
      alternateLocale: loc === 'en' ? ['pt_BR'] : loc === 'es-419' ? ['en_US', 'pt_BR'] : ['en_US'],
...
export function buildPricingJsonLd(locale = 'pt-BR') {
  ...
  const offer = {
    ...
    price: '0',
    priceCurrency: publicPricingCurrency(loc),
