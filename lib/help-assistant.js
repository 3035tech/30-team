...
const PRODUCT_HINT =
  /\b(30\s*team|30team|painel|dashboard|guia|ajuda|vaga|vacanc|candidato|candidate|eneagrama|enneagram|\bt[1-9]\b|motivador|motivator|pipeline|kanban|equipe|team\b|pdi|clima|climate|pulso|pulse|compat|grupo|group|rubrica|rubric|contratar|hire|hired|\/t\b|\/v\b|\/e\b|\/r\b|\/jobs|\/clima|\/pulso|assessment|recrut|triagem|screen|1:1|one[\s-]?on[\s-]?one|retencao|retention|onboarding|beneficio|academy|sucessao|succession|turnover|hr\s*score|desempenho|performance|cargo|job\s*role|overview|analytics|ranking|fit\b|nucleo|nucleus)\b/i;
