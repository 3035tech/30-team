...
/**
 * Extrai website / aboutHtml / publicProfileEnabled do body.
...
export function parseCompanyProfileFromBody(body = {}, { forCreate = false } = {}) {
  ...
  return { website, aboutHtml, publicProfileEnabled };
}

export const COMPANY_PROFILE_SQL_SELECT = `
  c.website,
  c.about_html AS "aboutHtml",
  c.public_profile_enabled AS "publicProfileEnabled"`.trim();
