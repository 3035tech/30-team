...
import { normalizeEmploymentType } from './vacancy-employment-type';
...
export function parseVacancyDetailsFromBody(body = {}, { forCreate = false } = {}) {
  ...
  return { description, salaryMin, salaryMax, clientReportShowSalary, employmentType };
}
...
export const VACANCY_DETAILS_SQL_SELECT = `
  ...
  v.employment_type AS "employmentType"`.trim();
