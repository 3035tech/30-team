/**
 * Integration: bootstrap + invite insert (no HTTP).
 * Uso: node test/unit/motivators-invite-flow.js
 *      npm run db:test-motivators
 * Requer POSTGRES_* no .env e migrations AE aplicadas.
 */
